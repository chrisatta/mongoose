...
-type options() :: #{max_stanza_size := non_neg_integer() | infinity,
...
-spec listener_to_receiver_opts(mongoose_listener:options()) -> options().
listener_to_receiver_opts(Opts) ->
    maps:with([max_stanza_size, hibernate_after], Opts).
